...
def make_csv_dataset(query_metas, file_path):
    ...
    for i, query_meta in enumerate(query_metas):
        ...
        query_unprocessed = query_meta['query']
        context = str(query_meta['context'])
        reply = str(query_meta['reply'])
    ...
    with open(file_path, 'w', newline='') as csvfile:
        ...
        csv_writer.writerow(['query_text', 'program_text', 'id', 'context', 'query_original', 'reply'])
...
def main():
    ...
    dataset_folder_path = '../dataset_of_queries/v2'
